...
class DeveloperListAdapter(private val clickListeners: DeveloperAdapterListener): BaseAdapter<Developer, DeveloperListItemBinding>(R.layout.developer_list_item){
